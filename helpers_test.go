...
func TestEqual(t *testing.T) {
	...
	testcases := []struct {
		...
		{scenario: "Equal(1,1)",
			act: func(t T) { Equal(t, 1, 1) },
			assert: func(test HelperTest) {
				test.DidPass()
				test.Report.IsEmpty()
			}},
		{scenario: "NotEqual(1,2)",
			act: func(t T) { NotEqual(t, 1, 2) },
			assert: func(test HelperTest) {
				test.DidPass()
				test.Report.IsEmpty()
			}},
		...
		{scenario: "Equal(0,255,FormatHex)",
			act: func(t T) { Equal(t, 0, 255, FormatHex) },
			assert: func(test HelperTest) {
				test.DidFail()
		...
		{scenario: "Equal(1,2,custom{w=2*g})",
			act: func(t T) { Equal(t, 1, 2, func(g, w int) bool { return w == 2*g }) },
			assert: func(test HelperTest) {
				test.DidPass()
				test.Report.IsEmpty()
			}},
		{scenario: "Equal(1,1,custom{w=2*g})",
			act: func(t T) { Equal(t, 1, 1, func(g, w int) bool { return w == 2*g }) },
			assert: func(test HelperTest) {
				test.DidFail()
		...
		{scenario: "NotEqual(1,1,custom{w=2*g})",
			act: func(t T) { NotEqual(t, 1, 1, func(g, w int) bool { return w == 2*g }) },
			assert: func(test HelperTest) {
				test.DidPass()
				test.Report.IsEmpty()
			}},
		{scenario: "NotEqual(1,2,custom{w=2*g})",
			act: func(t T) { NotEqual(t, 1, 2, func(g, w int) bool { return w == 2*g }) },
			assert: func(test HelperTest) {
				test.DidFail()
...
func TestDeepEqual(t *testing.T) {
	...
	testcases := []struct {
		...
		{scenario: "DeepEqual(1,1)",
			act: func(t T) { DeepEqual(t, 1, 1) },
			assert: func(test HelperTest) {
				test.DidPass()
				test.Report.IsEmpty()
			}},
		{scenario: "NotDeepEqual(1,2)",
			act: func(t T) { NotDeepEqual(t, 1, 2) },
			assert: func(test HelperTest) {
				test.DidPass()
				test.Report.IsEmpty()
			}},
		...
		{scenario: "DeepEqual(0,255, FormatHex)",
			act: func(t T) { DeepEqual(t, 0, 255, FormatHex) },
			assert: func(test HelperTest) {
				test.DidFail()
				test.Report.Contains([]string{
					currentFilename(),
		...
		{scenario: "NotDeepEqual(1,1)",
			act: func(t T) { NotDeepEqual(t, 1, 1) },
			assert: func(test HelperTest) {
				test.DidFail()
