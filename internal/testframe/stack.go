...
//
// The function checks if the top element can be type asserted to T and returns true
// if successful, putting a copy of the retrieved element in the variable referenced
// by the pointer argument. If the stack is empty or the type assertion fails, false
// is returned.
//
// The function is safe to call concurrently and will not modify the stack.
