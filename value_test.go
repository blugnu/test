...
// 			act: func(t *testing.T) { Value(t, 1).DoesNotEqual(1) },
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) { Value(t, 1).DoesNotEqual(1, ShallowEquality) },
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) { Value(t, 1).DoesNotEqual(2, func(g, w int) bool { return w == 2*g }) },
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) { Value(t, 1).Equals(2) },
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) { Value(t, 1).Equals(2, ShallowEquality) },
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) { Value(t, 1).Equals(1, func(g, w int) bool { return w == g*2 }) },
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) { Value(t, 1).IsNil() },
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) { Value(t, 1).IsNotNil() },
// 			assert: func(test HelperTest) {
// 				test.DidFail()
