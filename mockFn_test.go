...
// 				// ASSERT
// 				That(t, result1).Equals(&mockFnCall[int, int]{args: ByRef(1)})
// 				That(t, result2).Equals(&mockFnCall[int, int]{args: ByRef(2)})
// 				That(t, sut.expectations).Equals([]*mockFnCall[int, int]{{args: ByRef(1)}, {args: ByRef(2)}})
...
// 				// ASSERT
// 				That(t, sut).Equals(&mockFnCall[int, int]{args: ByRef(42)})
