...
// 		// EquivalentTo tests
// 		{scenario: "EquivalentTo (same slices)",
// 			act: func(t *testing.T) {
// 				s := []string{"a", "b"}
// 				Slice(t, s).EquivalentTo(s)
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
// 				test.Report.IsEmpty()
// 			},
// 		},
// 		{scenario: "EquivalentTo (similar slices)",
// 			act: func(t *testing.T) {
// 				Slice(t, []string{"a", "b"}).EquivalentTo([]string{"b", "a"})
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
// 				test.Report.IsEmpty()
// 			},
// 		},
// 		{scenario: "EquivalentTo (not equal slices)",
// 			act: func(t *testing.T) {
// 				Slice(t, []string{"a", "b"}).EquivalentTo([]string{"a", "b", "c"})
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidFail()
// 				test.Report.Contains("EquivalentTo_(not_equal_slices)")
// 				test.Report.Contains([]string{
// 					currentFilename(),
// 					"wanted: []string{\"a\", \"b\", \"c\"}",
// 					"got   : []string{\"a\", \"b\"}",
...
// 			},
// 		},
// 		{scenario: "EquivalentTo (case-insensitive comparison)",
// 			act: func(t *testing.T) {
// 				Slice(t, []string{"a", "b"}).EquivalentTo([]string{"A", "B"}, func(got, wanted string) bool {
// 					return strings.EqualFold(got, wanted)
// 				})
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
...
// 		// HasLength tests
// 		{scenario: "HasLength (equal length)",
// 			act: func(t *testing.T) {
// 				Slice(t, []string{"a", "b"}).HasLength(2)
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
// 				test.Report.IsEmpty()
// 			},
// 		},
// 		{scenario: "HasLength (not equal length)",
// 			act: func(t *testing.T) {
// 				Slice(t, []string{"a", "b"}).HasLength(3)
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidFail()
// 				test.Report.Contains("HasLength_(not_equal_length)")
// 				test.Report.Contains([]string{
// 					currentFilename(),
// 					"wanted: length 3",
// 					"got   : length 2",
...
// 		// SlicesEquivalent tests
// 		{scenario: "SlicesEquivalent(got == wanted)",
// 			act: func(t *testing.T) {
// 				SlicesEquivalent(t, []string{"a", "b"}, []string{"a", "b"})
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
// 				test.Report.IsEmpty()
...
// 		{scenario: "SlicesEquivalent(got ~= wanted)",
// 			act: func(t *testing.T) {
// 				SlicesEquivalent(t, []string{"a", "b"}, []string{"b", "a"})
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
// 				test.Report.IsEmpty()
...
// 		{scenario: "SlicesEquivalent(got != wanted)",
// 			act: func(t *testing.T) {
// 				SlicesEquivalent(t, []string{"a", "b"}, []string{"a", "a"})
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidFail()
// 				test.Report.Contains([]string{
