...
// 	testcases := []struct {
// 		scenario string
// 		act      func(*testing.T) HelperTest
// 		assert   func(HelperTest)
// 	}{
// 		{scenario: "Helper(func{}, \"\")",
// 			act: func(t *testing.T) HelperTest {
// 				return TestHelper(t, func(st *testing.T) {})
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
// 			},
...
// 			act: func(t *testing.T) HelperTest {
// 				return TestHelper(t, func(st *testing.T) { st.Fail() })
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) HelperTest {
// 				return TestHelper(t, func(st *testing.T) { st.Error("report message") })
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidFail()
...
// 			act: func(t *testing.T) HelperTest {
// 				return TestHelper(t, func(st *testing.T) { panic(42) })
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPanic(42)
