...
// 		{scenario: "CaseInsensitive(a, A)",
// 			exec: func(t *testing.T) {
// 				// ACT
// 				result := CaseInsensitive("a", "A")
...
// 			},
// 		},
// 		{scenario: "CaseInsensitive(a, b)",
// 			exec: func(t *testing.T) {
// 				// ACT
// 				result := CaseInsensitive("a", "b")
...
// 			},
// 		},
// 		{scenario: "Strings([a,a]).Equals([a,A], CaseInsensitive)",
// 			act: func(t *testing.T) {
// 				g := []string{"a", "a"}
// 				w := []string{"a", "A"}
// 				Strings(t, g).Equals(w, CaseInsensitive)
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
// 				test.Report.IsEmpty()
...
// 		// EquivalentTo tests
// 		{scenario: "Strings([a,b]).EquivalentTo([b,a])",
// 			act: func(t *testing.T) {
// 				g := []string{"a", "b"}
// 				w := []string{"b", "a"}
// 				Strings(t, g).EquivalentTo(w)
// 			},
// 			assert: func(test HelperTest) {
// 				test.DidPass()
// 				test.Report.IsEmpty()
// 			},
// 		},
// 		{scenario: "Strings([a,b,c]).EquivalentTo([a,a,d,c])",
// 			act: func(t *testing.T) {
// 				g := []string{"a", "b", "c"}
// 				w := []string{"a", "a", "d", "c"}
// 				Strings(t, g).EquivalentTo(w)
...
// 			},
// 		},
// 		{scenario: "Strings([a,b,c]).EquivalentTo([a,a,c])",
// 			act: func(t *testing.T) {
// 				g := []string{"a", "b", "c"}
// 				w := []string{"a", "a", "c"}
// 				Strings(t, g).EquivalentTo(w)
